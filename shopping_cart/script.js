...
class ShoppingCart{
    ...
    addItem(id,products) {
        ...
        <p><span class="product-count" id="product-count-for-id${product.id}"></span>${name}</p>
        <p>${price}</p>
        </div>`;
    }
...
//bind is used to ensure the correct 'this' context inside clearCart method
//without bind, 'this' would refer to the button element when clearCart is called as an event handler